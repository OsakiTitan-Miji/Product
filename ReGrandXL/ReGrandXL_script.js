const colorButtons = document.querySelectorAll(".ReGXL_colorButton");
const mainVisual = document.querySelector(".ReGXL_mainVisual");
const slides = document.querySelectorAll(".ReGXL_slide");
const arrows = document.querySelectorAll(".ReGXL_arrow");
const sliderTrack = document.querySelector(".ReGXL_sliderTrack");
const productNameEl = document.querySelector(".ReGXL_productName");
let currentSlide = 0;
